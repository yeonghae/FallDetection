import torch
import numpy as np
from module.Models import TwoStreamSpatialTemporalGraph
from module.Utils import normalize_points_with_size, scale_pose
...
class TSSTG():
    ...
    """
    def __init__(self,
                 weight_file='checkpoint/falldown_checkpoint.pth',
                 device='cuda:0'):

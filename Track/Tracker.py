...
class Track:
    def __init__(self, mean, covariance, track_id, n_init, max_age=30):#, buffer=17): ## 테스트용 임시 !! TMEP
        self.mean = mean
...
class Tracker:
    def __init__(self, max_iou_distance=0.7, max_age=30, n_init=5, confidence_threshold=0.4):
    ...
    # def _initiate_track(self, detection): # TODO 임시 TEMP
